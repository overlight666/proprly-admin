...
import { useDropzoneAction } from "@/_recoil/actions";
...
const DropzoneComponent = ({
    ...
    const dropzoneAction = useDropzoneAction();
    const uploadedImage = useRecoilValue(dropZoneAtom);

    const onDrop = (acceptedFiles: File[]) => {
        if (!isExcel) {
            dropzoneAction.uploadImage(acceptedFiles[0]);
        }
    ...
    return (
        <ComponentCard title={title} rightComponent={rightComponent}>
