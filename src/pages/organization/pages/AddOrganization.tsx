...
const AddOrganization: FC = function () {
    ...
    function onSubmit(values: any) {
        if (values?.users?.length > 0) {
            ...
            toast.error("Please register a builder!")
        }
        ...
        <NavbarSidebarLayout>
            <>
                ...
                <div className="grid grid-cols-1 gap-y-6 px-4 pt-4">
                    <BuilderInformation selectedOrganization={undefined} setFieldValue={formik.setFieldValue} values={formik.values} />
                </div>
                <div className="grid grid-cols-1 gap-y-6 px-4 pt-4">
                    <div className="col-span-6 flex gap-2">
                        <Button variant="outline" onClick={() => navigate(-1)}>Cancel</Button>
                        <Button type="submit" color="primary" onClick={() => formik.handleSubmit()}>Submit</Button>
                    </div>
