...
const OrgTable = function () {
  ...
  useEffect(() => {
    try {
      ...
      // });
      // datatable.update();
      if (!DataTable.isDataTable("#organization-project-table")) {
        new DataTable("#organization-project-table", {
          paging: true,
          searching: false,
          buttons: ["pageLength"],
          layout: {
            ...
            bottomStart: {
              pageLength: {
                text: "Showing _START_-_END_ of _TOTAL_ _MENU_",
              },
            },
            bottomEnd: "paging",
          },
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center rounded-md border border-transparent bg-green-100 px-2.5 py-0.5 text-sm text-green-800 shadow-sm transition-all">
                        <svg
                          className="mr-2"
                          width="10"
                          height="10"
                    ...
                    <td className="px-6 py-4">
                      <div className="mr-2 flex items-center rounded-md border border-transparent bg-blue-100 px-2.5 py-0.5 text-sm text-blue-800 shadow-sm transition-all">
                        <svg
                          className="mr-2"
                          width="10"
                          height="10"
                    ...
                    <td className="px-6 py-4">
                      {" "}
                      <div className="mr-2 flex items-center rounded-md border border-transparent bg-red-100 px-2.5 py-0.5 text-sm text-red-800 shadow-sm transition-all">
                        <svg
                          width="10"
                          height="10"
                          viewBox="0 0 10 10"
