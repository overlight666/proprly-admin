...
import FileUploader2 from "../ui/fileupload2";
...
export default function SupportTicketModal({
    ...
    const onSubmit = async () => {
        if (description.trim().length == 0) {
            ...
            await userAction.updateSupportTikets(ticket?.id, params).then((res) => {
                if (res) {
    ...
    return (
        <>
            <Modal
                isOpen={isOpen}
                onClose={closeModal}
                className="max-w-[90%] max-h-[80%] p-6 lg:p-10 relative overflow-auto"
            >
                <div className="flex flex-col px-2 overflow-auto custom-scrollbar">
                    ...
                    <div className="mt-8 space-y-3 grid grid-cols-1 md:grid-cols-12 gap-2">
                        ...
                        <ComponentCard
                            title="Activity Logs"
                            className="col-span-4  !mt-[0px] !max-h-[415px] min-h-[415px] overflow-auto"
                        >
                            <div className="gap-2 ">
