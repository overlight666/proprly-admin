...
const sidebarItems = [
  ...
  { id: 'configure-project', label: 'Configure Project', active: true }
];
...
export const ProjectSidebar: React.FC = () => {
  ...
  const handleNavigation = (itemId: string) => {
    if (itemId === 'configure-project') {
      navigate(`/organization/${organizationId}/project/${projectId}/configure`);
    } else {
      // Handle other navigation items
      navigate(`/organization/${organizationId}/project/view/${projectId}`);
    }
  };
