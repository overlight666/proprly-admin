                ...
                return (
                  <div key={index} className="flex w-full flex-col p-5 shadow">
                    <div className="flex w-full items-center justify-between">
                      <span className="text-[14px] font-bold">{org.name}</span>
                      <Button color="white">
                    ...
                    <div className="mt-2 flex flex-col">
                      ...
                      <div className="mt-2 flex justify-start text-[13px]">
                        ...
                        <div className="flex items-center rounded-md border border-transparent bg-yellow-100 px-2.5 py-0.5 text-sm text-yellow-800 shadow-sm transition-all">
                          <svg
                            width="10"
                            height="10"
                            viewBox="0 0 10 10"
