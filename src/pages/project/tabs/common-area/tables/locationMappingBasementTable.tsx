...
import { commonAreaCategoryResponseAtom, commonAreaChecklistAtom, commonAreaConfigAtom, selectedCommonAreaAtom, selectedProjectAtom } from "@/_recoil/states";
                ...
                <>
                    <div className="flex gap-5 space-y-5">
                        <div className="flex gap-3 items-center">
                            <Select
                                onChange={(e: any) => setSelectedBasement(e)}
                                options={[
                                    {
                                        label: "Basement",
                                        value: "basement",
