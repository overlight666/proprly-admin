...
import { projectTimelineAtom } from "@/_recoil/states";
import Radio from "@/components/ui/radio";
import { Button } from "@/components/ui/button";
import { hasViewDetails } from "@/helpers";
import { CalendarClock } from "lucide-react";

export default function TimeLine({ openModal }: any) {
    const { id }: any = useParams();
    const orgAction = useOrganization();
    const orgTimeline = useRecoilValue(projectTimelineAtom);
    ...
    return (
        <div className="rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6">
            <div className="flex items-start justify-between flex-col">
                ...
                <div className="relative inline-block mt-2 overflow-auto max-h-[450px] min-h-[450px] w-full">
                                ...
                                .map((timeline, index) => {
                                    return (
                                        <li className="mb-10 ms-6" key={index}>
                                            <span className="absolute flex items-center justify-center w-6 h-6 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-transparent dark:bg-blue-900 z-1">
                                                <CalendarClock className="size-4 dark:text-gray-100" />
                                            </span>
