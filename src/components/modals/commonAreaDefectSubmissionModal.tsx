...
export const CommonAreaDefectSubmittionModal = function (props: any) {
  const {
    isOpen,
    setOpen,
    setFeedbackOpen,
                  ...
                  <div className="col-span-2 col-start-1 row-start-1">
                    ...
                    {showCard1 && (
                      <div className="grid auto-rows-min grid-cols-3 gap-4 pt-5">
                        ...
                        <div className="flex flex-col">
                          <Label htmlFor="unitNo">CA Lot no</Label>
                          <TextInput
                            disabled={true}
                            id="unitNo"
                            name="unitNo"
                            value={
                              defect && defect.commonArea
                        ...
                        <div className="flex flex-col">
                          <Label htmlFor="zone">Common Area Category</Label>
                          <TextInput
                            disabled={true}
                            id="zone"
                            name="zone"
                            value={
                              defect && defect.commonAreaCategory
                                ? defect.commonAreaCategory.name
                                : ""
                            }
                    ...
                    {showCard3 && (
                      <Table>
                        ...
                        <Table.Body>
                          {(defect &&
                            defect.user &&
                            Array.isArray(defect.user) &&
                            defect?.user.map((u: userData, index) => {
                              return (
                                <Table.Row key={index}>
                      ...
                      <div className="flex gap-3">
                        <Button
                          ...
                          onClick={() => {
                            ...
                            setFeedbackOpen(true);
                            setFeedback("reopen");
                            setFeedbackTitle("Re-Open Defect");
                          }}
                        >
                          <div className="flex items-center gap-x-2">
                            Re-open Defect
