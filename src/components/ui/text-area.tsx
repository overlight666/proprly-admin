...
const TextArea: React.FC<TextareaProps> = ({
    ...
    if (disabled) {
        ...
        textareaClasses += ` bg-transparent  border-red-300 focus:border-red-300 focus:ring focus:ring-red-500/10 dark:border-red-300 dark:bg-gray-900 dark:text-white/90 dark:focus:border-red-800`;
    } else {
