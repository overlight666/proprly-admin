...
const TextArea: React.FC<TextareaProps> = ({
  ...
  if (disabled) {
    ...
    textareaClasses += ` bg-transparent  border-error-300 focus:border-error-300 focus:ring focus:ring-error-500/10 dark:border-error-300 dark:bg-gray-900 dark:text-white/90 dark:focus:border-error-800`;
  } else {
