...
import { listPropertiesAtom } from "@/_recoil/states";
...
import ExportPropertyReportModal from "@/components/modals/exportPropertyReportModal";
...
export default function PropertyTable({
    ...
    return (
        <div className="overflow-hidden rounded-md bg-white dark:border-white/[0.05] dark:bg-white/[0.03] px-2">
                    ...
                    <DataTable
                        ...
                        options={{
                            ...
                            columnDefs: [
                                ...
                                {
                                    className:
                                        "text-[12px] px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400 text-[13px]",
                                    targets: "_all",
                                },
                            ],
                                ...
                                <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400 text-[13px]">
                                    <div className="flex gap-2">
                                        <PencilIcon
                                            onClick={() =>
                                                navigate(
                                                    `/organization/${id}/project/${project_id}/property/view/${_data}`
                                                )
                                            }
